      ...
      <div id="carousel-slider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active">
            <img src="<?php echo base_url("public/img/home1.jpg"); ?>" class="img-responsive" alt="">
            <div class="carousel-caption">
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.6s">
                <div class="form-inline">
                  <div class="form-group">
                    <button type="livedemo" onclick="javascript:location.href='<?php echo base_url("member/account/login"); ?>'" class="btn btn-primary btn-lg" required="required">Login </button>
                  </div>
                  <div class="form-group">
                    <button type="getnow" onclick="javascript:location.href='<?php echo base_url("member/account/register"); ?>'" name="Get Now" class="btn btn-primary btn-lg" required="required">Register</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="item">
            <img src="<?php echo base_url("public/img/home2.jpg"); ?>" class="img-responsive" alt="">
            <div class="carousel-caption">
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.9s">
                <div class="form-inline">
                  <div class="form-group">
                    <button type="livedemo" onclick="javascript:location.href='<?php echo base_url("member/account/login"); ?>'" name="Live Demo" class="btn btn-primary btn-lg" required="required">Login </button>
                  </div>
                  <div class="form-group">
                    <button type="getnow" onclick="javascript:location.href='<?php echo base_url("member/account/register"); ?>'" name="Get Now" class="btn btn-primary btn-lg" required="required">Register</button>
                  </div>
          ...
          <div class="item">
            <img src="<?php echo base_url("public/img/home3.jpg"); ?>" class="img-responsive" alt="">
            <div class="carousel-caption">
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.6s">
                <div class="form-inline">
                  <div class="form-group">
